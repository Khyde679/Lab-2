...
public class EventPlanner {
    ...
    static void addDefaultEvents(EventListPanel events) {       //Adds some default events
        Deadline defaultDeadline = (Deadline) new DeadlineFactory().getEvent("Assignment", LocalDateTime.of(2025,2, 18, 11, 59), null, null);
        Meeting defaultMeeting = (Meeting) new MeetingFactory().getEvent("Class", LocalDateTime.of(2025, 2, 18, 4, 0), LocalDateTime.of(2025, 2, 18, 5, 10), "Zoom");
